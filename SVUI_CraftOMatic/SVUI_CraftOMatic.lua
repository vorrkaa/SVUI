...
function PLUGIN:Load()
	...
	tool4.icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
	...
	tool3.icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
	...
	tool2.icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
	...
	tool1.icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
	...
	local ModeAlert = CreateFrame("Frame", nil, SV.Screen, "BackdropTemplate")
