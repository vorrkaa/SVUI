...
local function HelpFrameStyle()
	...
	HelpFrame.Bg:Hide()
	SV.API:Set("Window", HelpFrame)
	HelpFrame.TitleContainer.TitleText:SetFontObject(SVUI_Font_Header)
	SV.API:Set("CloseButton", HelpFrame.CloseButton)

	HelpFrame.Browser.BrowserInset:RemoveTextures(true)
	HelpFrame.Browser.BrowserInset:SetStyle("Frame", "Default")

	--TODO: More later on retail
