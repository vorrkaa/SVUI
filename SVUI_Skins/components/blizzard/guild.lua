...
local function StyleSortingButton(button)
	...
	outer:SetGradient("VERTICAL", CreateColor(0.4, 0.47, 0.5), CreateColor(0.3, 0.33, 0.35))
	...
	if button.SetNormalTexture then
		...
		iconTex:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
...
local function GuildControlStyle()
	...
	--TODO: NEED TO BE REDONE ON RETAIL WITH A GUILD
