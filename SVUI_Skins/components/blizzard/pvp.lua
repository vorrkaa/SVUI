...
local function PVPFrameStyle()
	...
	HonorFrame.TankIcon:GetNormalTexture():SetTexCoord(0, 0.25, 0.25, 0.5)
	...
	HonorFrame.HealerIcon:GetNormalTexture():SetTexCoord(0.25, 0.5, 0, 0.25)
	...
	HonorFrame.DPSIcon:GetNormalTexture():SetTexCoord(0.25, 0.5, 0.25, 0.5)
	...
	ConquestFrame.DPSIcon:RemoveTextures()
    ConquestFrame.TankIcon:RemoveTextures()
    ConquestFrame.HealerIcon:RemoveTextures()
	ConquestFrame.DPSIcon.checkButton:SetStyle("CheckButton")
	ConquestFrame.TankIcon.checkButton:SetStyle("CheckButton")
	ConquestFrame.HealerIcon.checkButton:SetStyle("CheckButton")
	ConquestFrame.TankIcon:DisableDrawLayer("OVERLAY")
	ConquestFrame.TankIcon:DisableDrawLayer("BACKGROUND")
	ConquestFrame.TankIcon:SetNormalTexture("Interface\\AddOns\\SVUI_Skins\\artwork\\UI-LFG-ICON-ROLES")
	ConquestFrame.TankIcon:GetNormalTexture():SetTexCoord(0, 0.25, 0.25, 0.5)
	ConquestFrame.HealerIcon:DisableDrawLayer("OVERLAY")
	ConquestFrame.HealerIcon:DisableDrawLayer("BACKGROUND")
	ConquestFrame.HealerIcon:SetNormalTexture("Interface\\AddOns\\SVUI_Skins\\artwork\\UI-LFG-ICON-ROLES")
	ConquestFrame.HealerIcon:GetNormalTexture():SetTexCoord(0.25, 0.5, 0, 0.25)
	ConquestFrame.DPSIcon:DisableDrawLayer("OVERLAY")
	ConquestFrame.DPSIcon:DisableDrawLayer("BACKGROUND")
	ConquestFrame.DPSIcon:SetNormalTexture("Interface\\AddOns\\SVUI_Skins\\artwork\\UI-LFG-ICON-ROLES")
	ConquestFrame.DPSIcon:GetNormalTexture():SetTexCoord(0.25, 0.5, 0.25, 0.5)
