...
local Hook_QuestNPCModel = function(self, _, _, _, _, _, x, y, _)
	...
	if QuestNPCModelTextFrame and not QuestNPCModelTextFrame.skinned then
		...
		QuestNPCModelTextFrame.SetParent(QuestModelScene)
		QuestNPCModelTextFrame.skinned = true
	end
end
...
local function QuestFrameStyle()
	...
	QuestLogPopupDetailFrame.Inset:Hide()
	QuestLogPopupDetailFrame.AbandonButton:SetStyle("Button")
	QuestLogPopupDetailFrame.TrackButton:SetStyle("Button")
	QuestLogPopupDetailFrame.ShareButton:SetStyle("Button")
	SV.API:Set("CloseButton", QuestLogPopupDetailFrame.CloseButton)

	QuestLogPopupDetailFrame.ScrollFrame.ScrollBar:RemoveTextures(true)

	QuestProgressScrollFrame.ScrollBar:RemoveTextures(true)
	QuestDetailScrollFrame.ScrollBar:RemoveTextures(true)
	QuestDetailScrollChildFrame:RemoveTextures(true)
	QuestRewardScrollFrame.ScrollBar:RemoveTextures(true)
	...
	QuestGreetingScrollFrame.ScrollBar:RemoveTextures(true)
	-- QuestDetailScrollFrame.ScrollBar:RemoveTextures(true)

	QuestScrollHelper(QuestDetailScrollFrame, 506, 615, true)
	QuestDetailScrollFrame.ScrollBar:SetStyle("!_Frame")
	QuestScrollHelper(QuestProgressScrollFrame, 506, 615, true)
	QuestProgressScrollFrame.ScrollBar:SetStyle("!_Frame")
	QuestScrollHelper(QuestGreetingScrollFrame, 506, 615, true)
	QuestGreetingScrollFrame.ScrollBar:SetStyle("!_Frame")
	...
	QuestLogPopupDetailFrameScrollFrame:ClearAllPoints()
	QuestLogPopupDetailFrameScrollFrame:SetPoint("TOPLEFT", QuestLogPopupDetailFrame, "TOPLEFT", 16, -65)
	...
	QuestModelScene:RemoveTextures()
	QuestModelScene:SetStyle("Model", "Frame")
	...
	SV.NPC:Register(QuestFrame, QuestNPCModelNameText)
end
