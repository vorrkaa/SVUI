...
local function FriendsFrameStyle()
	...
	FriendsFrame.Inset:RemoveTextures()
	FriendsFrame.Inset:Hide()
	...
	-- FriendsFrame.Inset:SetStyle("!_Frame", "Model")
	...
	FriendsListFrame:DisableDrawLayer("BACKGROUND")

	SV.API:Set("ScrollBar", FriendsListFrame, 5)
	SV.API:Set("ScrollBar", WhoFrame, 5)
	SV.API:Set("ScrollBar", IgnoreListFrame, 5)
	SV.API:Set("ScrollBar", ChannelFrame.ChannelRoster.ScrollFrame, 5)
	SV.API:Set("ScrollBar", QuickJoinFrame, 5)
	...
	SV.API:Set("EditBox", WhoFrameEditBox)
	...
	SV.API:Set("Window", FriendsFriendsFrame)
	-- FriendsFriendsFrame:SetStyle("Frame")

	-- _G["FriendsFriendsList"]:RemoveTextures()
	--_G["FriendsFriendsNoteFrame"]:RemoveTextures()

	FriendsFriendsFrame.SendRequestButton:SetStyle("Button")
	FriendsFriendsFrame.CloseButton:SetStyle("Button")
	FriendsFriendsFrame.Border:Hide()
	...
	SV.API:Set("ScrollBar", FriendsFriendsFrame, 4)

	SV.API:Set("Window", AddFriendFrame)
	AddFriendFrame.Border:Hide()

	FriendsFrame.TitleContainer.TitleText:SetFontObject(SVUI_Font_Header)
	FriendsFrame.TitleContainer:ClearAllPoints()
	FriendsFrame.TitleContainer:SetPoint("TOPLEFT", FriendsFrame, 24, -1)
	FriendsFrame.TitleContainer:SetPoint("TOPRIGHT", FriendsFrame, -24, -1)
