...
local function RaidInfoStyle()
	...
	SV.API:Set("Button", RaidFrameRaidInfoButton)
	SV.API:Set("Button", RaidFrameConvertToRaidButton)
	RaidFrameAllAssistCheckButton:SetStyle("Editbox")

	SV.API:Set("Window", RaidInfoFrame)
	RaidInfoFrame.Border:RemoveTextures()
	RaidInfoFrame.Border:Hide()
	SV.API:Set("CloseButton", RaidInfoCloseButton)
	SV.API:Set("Button", RaidInfoExtendButton)
	SV.API:Set("Button", RaidInfoCancelButton)
	SV.API:Set("ScrollBar", RaidInfoFrame)
	RaidInfoInstanceLabel:RemoveTextures()
	RaidInfoIDLabel:RemoveTextures()
	RaidInfoFrame.Header:RemoveTextures()
	RaidInfoFrame.Header.Text:SetFontObject(_G.SVUI_Font_Header)
