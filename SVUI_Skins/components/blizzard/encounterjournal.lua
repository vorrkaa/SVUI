...
local function _hook_EncounterJournal_ListInstances()
  for i, elementFrame in EncounterJournal.instanceSelect.ScrollBox:EnumerateFrames() do
    Outline(elementFrame)
  end
end
...
local function _hook_EncounterJournal_LootUpdate()
  local scrollFrame = EncounterJournal.encounter.info.LootContainer.ScrollBox;

  local items = scrollFrame:GetFrames()
  local item;
...
local function EncounterJournalStyle()
    ...
    EncounterJournal.TitleContainer.TitleText:SetFontObject(SVUI_Font_Header)
    ...
    EncounterJournalInset.NineSlice:RemoveTextures(true)
    ...
    EncounterJournalEncounterFrameInfo.LootContainer.classClearFilter:RemoveTextures(true)
    ...
    EncounterJournalEncounterFrameInfoOverviewScrollFrame.ScrollBar:RemoveTextures()
    ...
    SV.API:Set("ScrollBar", EncounterJournalInstanceSelect)
    SV.API:Set("ScrollBar", EncounterJournalEncounterFrameInfo)
    SV.API:Set("ScrollBar", EncounterJournalEncounterFrameInfoOverviewScrollFrame)
    SV.API:Set("ScrollBar", EncounterJournalEncounterFrameInfo.LootContainer)
    ...
    EncounterJournalEncounterFrameInfo.LootContainer.filter:SetStyle("Button")
    EncounterJournalEncounterFrameInfo.LootContainer.filter:SetFrameLevel(EncounterJournalEncounterFrameInfo.LootContainer.filter:GetFrameLevel() + 10)
    ...
    EncounterJournal.LootJournalItems:RemoveTextures(true)
    ...
    local loreParent = EncounterJournal.encounter.instance.LoreScrollingFont
    ...
    loreParent:SetTextColor(CreateColor(1, 1, 1))
