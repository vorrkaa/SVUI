...
local function CalendarStyle()
	...
	CalendarCreateEventFrame.Header:RemoveTextures()
	...
	CalendarTexturePickerFrame.Header:RemoveTextures()
	CalendarTexturePickerFrame:SetStyle("!_Frame", "Transparent", true)
	SV.API:Set("ScrollBar", CalendarTexturePickerFrame)
	...
	CalendarMassInviteFrame.Header:RemoveTextures()
	SV.API:Set("CloseButton", CalendarMassInviteCloseButton)
	CalendarMassInviteAcceptButton:SetStyle("Button")

	SV.API:Set("DropDown", CalendarMassInviteFrame.CommunityDropdown, 130)

	CalendarMassInviteMinLevelEdit:SetStyle("Editbox")
	CalendarMassInviteMaxLevelEdit:SetStyle("Editbox")
	...
	CalendarViewRaidFrame.Header:RemoveTextures()
	...
	CalendarViewHolidayFrame.Header:RemoveTextures()
	...
	CalendarViewEventFrame.Header:RemoveTextures()
	...
	SV.API:Set("ScrollBar", CalendarViewEventInviteList)
	for _,btn in pairs(CalendarButtons)do
		 _G[btn]:SetStyle("Button")
	end 
	CalendarEventPickerFrame:RemoveTextures()
	CalendarEventPickerFrame.Header:RemoveTextures()
	CalendarEventPickerFrame:SetStyle("!_Frame", "Transparent", true)
	SV.API:Set("ScrollBar", CalendarEventPickerFrame)
	CalendarEventPickerCloseButton:SetStyle("Button")
	SV.API:Set("ScrollBar", CalendarCreateEventDescriptionContainer)
	SV.API:Set("ScrollBar", CalendarCreateEventInviteList)
	SV.API:Set("ScrollBar", CalendarViewEventDescriptionContainer)
end 
--[[ 
########################################################## 
MOD LOADING
