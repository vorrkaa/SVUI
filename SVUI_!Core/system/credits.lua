...
|cffff9900MAINTAINED BY:|r  Vorka
|cff4f4f4f---------------------------------------------|r
|cffff9900CODE GRANTS BY:|r  Azilroka, Sortokk, Kkthnx, JoeyMagz, Vorka
|cff4f4f4f---------------------------------------------|r
|cffff9900UPGRADED FOR THE WAR WITHIN BY:|r  Vorka
|cff4f4f4f---------------------------------------------|r
...
local function ShowIssueString()
  ...
  local WEEKDAY = t.weekday
  local MONTHNUM = t.month
  local DAYNUM = t.monthDay
  local YEARNUM = t.year
