...
local function CreateMinionOptions(i)
	...
	option.txt = option:CreateFontString(nil,"OVERLAY")
...
local function CreateHenchmenSubOptions(buttonIndex,optionIndex)
	...
	frame.txt = frame:CreateFontString(nil,"OVERLAY")
...
local function CreateHenchmenFrame()
	...
	local HenchmenFrameBG = CreateFrame("Frame", "HenchmenFrameBG", UIParent, "BackdropTemplate")
	...
	h_option.txt = h_option:CreateFontString(nil,"OVERLAY")
	...
	m_option.txt = m_option:CreateFontString(nil,"OVERLAY")
...
function SV:ToggleHenchman()
	...
	if not HenchmenFrame:IsShown()then
		...
		SV.HenchmenButton.Icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
	end
end
--[[
##########################################################
