...
SV.SpecialFX:Register("dragging_highlight_top", 359118, 0, 0, 0, -80, 0.8, 0, 2.5) --[[Spells\Creature_spellportal_blue_clickable.m2]]
SV.SpecialFX:Register("dragging_highlight_bottom", 359118, 0, 80, 0, 0, 0.9, 0, -0.25) --[[Spells\Creature_spellportal_blue_clickable.m2]]
...
local UpdateBackdrop = function(self)
	...
	if(SV.db.Dock.backdrop and (not MOD.private.Disabled[self:GetName() .. 'Button'])) then
		if(self.backdrop.forceTop or (centerY and (centerY > heightTop))) then
			self.backdrop.underlay:SetGradient("VERTICAL", CreateColor(0, 0, 0, 0), CreateColor(0, 0, 0, 0.8))
			self.backdrop.left:SetGradient("VERTICAL", CreateColor(0, 0, 0, 0), CreateColor(0, 0, 0, 1))
			self.backdrop.right:SetGradient("VERTICAL", CreateColor(0, 0, 0, 0), CreateColor(0, 0, 0, 1))
			...
			self.backdrop.underlay:SetGradient("VERTICAL", CreateColor(0, 0, 0, 0.8), CreateColor(0, 0, 0, 0))
			self.backdrop.left:SetGradient("VERTICAL", CreateColor(0, 0, 0, 1), CreateColor(0, 0, 0, 0))
			self.backdrop.right:SetGradient("VERTICAL", CreateColor(0, 0, 0, 1), CreateColor(0, 0, 0, 0))
...
---@param self any
---@param onleftclick function
---@param onrightclick function
---@param extendedoptions function
...
function MOD:Load()
	...
	for location, settings in pairs(DOCK_LOCATIONS) do
		...
		if(location:find('Top')) then
			...
			highlight.texture:SetGradient("VERTICAL", CreateColor(0,0,1,0), CreateColor(0, 0.8, 1, 0.8))
			...
			highlight.texture:SetGradient("VERTICAL", CreateColor(0,0.8,1,0.8), CreateColor(0, 0, 1, 0))
		end
		highlight:Hide()
