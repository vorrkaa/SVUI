...
MOD.Plugins = {};
MOD.References = {};
MOD.ToolTip = CreateFrame("GameTooltip", "SVUI_Report_ToolTip", UIParent, "GameTooltipTemplate, BackdropTemplate");
...
local function GetDataSlot(parent, index)
	if(not parent.Stats.Slots[index]) then
		...
		slot.barframe = CreateFrame("Frame", nil, slot, "BackdropTemplate")
