...
BreakStuffButton.icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
...
local BreakStuffHandler = CreateFrame('Button', "BreakStuffHandler", UIParent, 'SecureActionButtonTemplate, AnimatedShineTemplate')
...
do
  local SkellyKeys = {
	[GetSpellInfo(269064).name] = true, -- Monelite Skeleton Key
	[GetSpellInfo(195881).name] = true, -- Jeweled Lockpick
	[GetSpellInfo(130100).name] = true, -- Ghostly Skeleton Key
	[GetSpellInfo(94574).name] = true, -- Obsidium Skeleton Key
	[GetSpellInfo(59403).name] = true, -- Titanium Skeleton Key
	[GetSpellInfo(59404).name] = true, -- Colbat Skeleton Key
	[GetSpellInfo(20709).name] = true, -- Arcanite Skeleton Key
	[GetSpellInfo(19651).name] = true, -- Truesilver Skeleton Key
	[GetSpellInfo(19649).name] = true, -- Golden Skeleton Key
	[GetSpellInfo(19646).name] = true, -- Silver Skeleton Key
  }
  local BreakableFilter = {
	["Pickables"]={['68729']=true,['63349']=true,['45986']=true,['43624']=true,['43622']=true,['43575']=true,['31952']=true,['12033']=true,['29569']=true,['5760']=true,['13918']=true,['5759']=true,['16885']=true,['5758']=true,['13875']=true,['4638']=true,['16884']=true,['4637']=true,['4636']=true,['6355']=true,['16883']=true,['4634']=true,['4633']=true,['6354']=true,['16882']=true,['4632']=true,['88165']=true,['88567']=true,['121331']=true},
...
local BreakStuff_OnLeave = function(self)
	if BreakStuffHandler.ReadyToSmash ~= true then
		...
		self.icon:SetGradient("VERTICAL", CreateColor(0.5, 0.53, 0.55), CreateColor(0.8, 0.8, 1))
		GameTooltip:Hide()
	end
end
...
local function LoadToolBreakStuff()
	...
	if(IsSpellKnown(51005)) then
		--print("Milling")
		allowed = true
		spellName = GetSpellInfo(51005).name
	...
	if(IsSpellKnown(31252)) then
		--print("Prospecting")
		allowed = true
		spellName = GetSpellInfo(31252).name
	...
	if(IsSpellKnown(2018)) then
		--print("Blacksmithing")
		allowed = true
		SMITH = GetSpellBookItemInfo((GetSpellInfo(2018).name))
    local count = #spellListing + 1;
	...
	TooltipDataProcessor.AddTooltipPostCall(Enum.TooltipDataType.Item, BreakStuffParser)
