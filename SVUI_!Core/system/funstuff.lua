...
local WORN_ITEMS = {};
local DRUNK_EFFECT = 166441 --[[Spells\\Largebluegreenradiationfog.m2]];
local DRUNK_EFFECT2 = 591559 --[[Spells\\Monk_drunkenhaze_impact.m2]];
local TIPSY_FILTERS = {
...
local function InitializeFunStuff()
	...
	drunk.ScreenEffect1:SetModel(DRUNK_EFFECT) --166441
	...
	npc.InfoTop = CreateFrame("Frame", nil, npc, "BackdropTemplate")
