...
function SV.Setup:LoadInstaller(autoLoaded)
	...
	if not SVUI_InstallerFrame then
		local frame = CreateFrame("Button", "SVUI_InstallerFrame", UIParent, "BackdropTemplate")
		...
		frame.Option01.texture:SetGradient("VERTICAL", CreateColor(0, 0.3, 0), CreateColor(0, 0.7, 0))
		...
		frame.Option01:SetScript("OnLeave", function(this)
			this.texture:SetGradient("VERTICAL", CreateColor(0, 0.3, 0), CreateColor(0, 0.7, 0))
		end)
		...
		frame.Option02.texture:SetGradient("VERTICAL", CreateColor(0, 0.1, 0.3), CreateColor(0, 0.5, 0.7))
		frame.Option02:SetScript("OnEnter", function(this)
			this.texture:SetVertexColor(0.5, 1, 0.4)
		end)
		frame.Option02:SetScript("OnLeave", function(this)
			this.texture:SetGradient("VERTICAL", CreateColor(0, 0.1, 0.3), CreateColor(0, 0.5, 0.7))
		end)
		...
		frame.Option03.texture:SetGradient("VERTICAL", CreateColor(0.3, 0, 0), CreateColor(0.7, 0, 0))
		...
		frame.Option03:SetScript("OnLeave", function(this)
			this.texture:SetGradient("VERTICAL", CreateColor(0.3, 0, 0), CreateColor(0.7, 0, 0))
		end)
		...
		frame.Option1.texture:SetGradient("VERTICAL", CreateColor(0.3, 0.3, 0.3), CreateColor(0.7, 0.7, 0.7))
		frame.Option1:SetScript("OnEnter", function(this)
			this.texture:SetVertexColor(0.5, 1, 0.4)
		end)
		frame.Option1:SetScript("OnLeave", function(this)
			this.texture:SetGradient("VERTICAL", CreateColor(0.3, 0.3, 0.3), CreateColor(0.7, 0.7, 0.7))
		end)
		...
		frame.Option2.texture:SetGradient("VERTICAL", CreateColor(0.3, 0.3, 0.3), CreateColor(0.7, 0.7, 0.7))
		...
		frame.Option3.texture:SetGradient("VERTICAL", CreateColor(0.3, 0.3, 0.3), CreateColor(0.7, 0.7, 0.7))
		...
		frame.Option4.texture:SetGradient("VERTICAL", CreateColor(0.3, 0.3, 0.3), CreateColor(0.7, 0.7, 0.7))
