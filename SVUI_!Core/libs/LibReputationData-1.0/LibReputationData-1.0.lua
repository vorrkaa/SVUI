...
---Utility function to copy table
---@param tbl table
---@return table
...
---Return all faction info from index
...
---Return search the factionName in allFactions table and return the index
...
---TODO Inspect this functionality
...
local function UpdateFaction(factionIndex)
	...
	allFactions[factionIndex] = GetFactionDataByIndex(factionIndex)
end
...
local function EnsureFactionsLoaded()
	...
	if GetFactionDataByIndex(1) == nil or (IsInGuild() and GetGuildInfo("player") == nil) then
