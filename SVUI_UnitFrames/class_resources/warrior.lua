...
SV.SpecialFX:Register("conqueror", 593694, 2, -2, -2, 2, 0.9, 0, 0.8) --[[Spells\Warlock_destructioncharge_impact_chest.m2]]
--[[ 
########################################################## 
POSITIONING
##########################################################
...
function MOD:CreateClassBar(playerFrame)
	...
	enrage.text = enrage:CreateFontString(nil, "OVERLAY")
	enrage.text:SetPoint("LEFT")
	enrage.text:SetFontObject(SVUI_Font_Unit_Small)
	enrage.text:SetJustifyH('LEFT')
	enrage.text:SetTextColor(1, 0.8, 0)
	enrage.text:SetText("")
