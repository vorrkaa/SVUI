...
SV.SpecialFX:Register("trap_fire", 166158, -12, 12, 12, -12, 0.6, 0, 0.2) --[[Spells\Fireshot_missile.m2]]
SV.SpecialFX:Register("trap_ice", 166217, -12, 12, 12, -12, 0.6, 0, 0.18) --[[Spells\Frostshot_missile.m2]]
SV.SpecialFX:Register("trap_frost", 165714, -12, 12, 12, -12, 0.6, -0.1, 0.22) --[[Spells\Blindingshot_missile.m2]]
SV.SpecialFX:Register("trap_snake", 166648, -12, 12, 12, -12, 0.4, 0, -0.21) --[[Spells\Poisonshot_missile.m2]]
local specEffects = {
	[1] = "trap_fire",
	[2] = "trap_ice",
	[3] = "trap_frost",
