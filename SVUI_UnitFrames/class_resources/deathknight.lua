...
SV.SpecialFX:Register("rune_blood", 591559, 0, 0, 0, 0, 0.00001, 0, 0.3) -- [[Spells\Monk_drunkenhaze_impact.m2]]
SV.SpecialFX:Register("rune_frost", 166367, 0, 0, 0, 0, 0.00001, -0.2, 0.4) --[[Spells\Ice_cast_low_hand.m2]]
SV.SpecialFX:Register("rune_unholy", 166645, 0, 0, 0, 0, 0.13, -0.3, -0.2) --[[Spells\Poison_impactdot_med_chest.m2]]
SV.SpecialFX:Register("rune_death", 166813, 0, 0, 0, 0, 0.001, 0, -0.25) --[[Spells\Shadow_strikes_state_hand.m2]]
local specEffects = {
	[1] = "rune_blood",
	[2] = "rune_frost",
	[3] = "rune_unholy",
...
local Reposition = function(self)
	...
	if(db.classbar.altRunes) then
		for i = 1, max do
			...
			-- elseif i == 2 then
			-- 	bar[i]:SetPoint("LEFT", bar[1], "RIGHT", -2, 0)
			else
...
function MOD:CreateClassBar(playerFrame)
	...
	for i=1, max do
		...
		bgTexture:SetGradient("VERTICAL",CreateColor(0,0,0,0.5),CreateColor(0,0,0,0.85))
