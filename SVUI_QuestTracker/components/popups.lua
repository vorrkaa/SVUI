...
local GetQuestLogTitle = C_QuestLog.GetTitleForQuestID
--[[
##########################################################
GET ADDON DATA
##########################################################
...
function MOD:InitializePopups()
	...
	hooksecurefunc(QuestObjectiveTracker, "AddAutoQuestPopUp", _hook_AddAutoPopUpQuests);
	hooksecurefunc(QuestObjectiveTracker, "RemoveAutoQuestPopUp", _hook_RemoveAutoPopUpQuests);
