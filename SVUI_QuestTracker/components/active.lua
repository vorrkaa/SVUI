...
local GetQuestLogTitle  				= C_QuestLog.GetTitleForLogIndex -- _G.GetQuestLogTitle;
...
local IsQuestComplete  					= C_QuestLog.IsComplete --_G.IsQuestComplete;
local GetSuperTrackedQuestID			= C_SuperTrack.GetSuperTrackedQuestID -- _G.GetSuperTrackedQuestID;
...
function MOD:InitializeActive()
	...
	block.Button = CreateFrame("Button", nil, block, "BackdropTemplate")
	...
	self:RegisterEvent("SUPER_TRACKING_CHANGED", self.UpdateActiveObjective);
